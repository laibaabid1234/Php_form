      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
        <div class="dropdown-header">
          <div class="d-flex mb-1">
            ...
            <div class="flex-grow-1 ms-3">
              <h6 class="mb-1"><?php echo $_SESSION['user_name'] ?></h6>
            </div>
          </div>
        </div>
        ...
        <div class="tab-content" id="mysrpTabContent">
          <div class="tab-pane fade show active" id="drp-tab-1" role="tabpanel" aria-labelledby="drp-t1" tabindex="0">
           <a href="<?php echo $basePath; ?>users/user-profile.php?id=<?php echo $row['id'] ?>" class="dropdown-item">
           <i class="ti ti-user"></i>
              <span>Profile</span>
            </a>
            <a href="<?php echo $basePath; ?><?php echo $basePath; ?>logout.php" class="dropdown-item">
